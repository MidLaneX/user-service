...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, UserConfirmationEvent> userConfirmationProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, UserConfirmationEvent> userConfirmationKafkaTemplate() {
        return new KafkaTemplate<>(userConfirmationProducerFactory());
    }
}
